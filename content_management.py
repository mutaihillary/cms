def Content():
    ...
    TOPIC_DICT = {"Basics": [["Python Introduction", "/introduction-to-python-programming/", [""]],
                             ...
                             ["How to Parse a Website with regex and urllib",
                              "/parse-website-using-regular-expressions-urllib/"],
                  ...
                  "PyGame": [["Introduction to PyGame", "/pygame-python-3-part-1-intro/"],
                             ...
                             ["PyGame Buttons, part 1, drawing the rectangle",
                              "/pygame-buttons-part-1-button-rectangle/"],
                             ["PyGame Buttons, part 2, making the buttons interactive",
                              "/making-interactive-pygame-buttons/"],
                  ...
                  "PyOpenGL": [["OpenGL with PyOpenGL introduction and creation of Rotating Cube",
                               ...
                               ["Optimizing the processing for infinite cubes",
                                "/improving-infinite-3d-cubes-pyopengl-tutorial/"], ],

                  "Kivy": [["Kivy with Python tutorial for Mobile Application Development Part 1",
                  ...
                  "Flask": [["Intro and environment creation", "/flask-web-development-introduction/"],
                            ...
                            ["Using javascript plugins, with a Highcharts example",
                             "/adding-js-plugins-flask-highcharts-example/"],
                  ...
                  "Data Manipulation": [["Intro to Pandas and Saving to a CSV and reading from a CSV",
                                         "/pandas-saving-reading-csv-file/"],
                  ...
                  "Data Visualization": [["Matplotlib Crash Course", "/matplotlib-python-3-basics-tutorial/"],
                                         ...
                                         ["3D Scatter Plot with Python and Matplotlib",
                                          "/matplotlib-3d-scatterplot-tutorial/"],
                                         ["More 3D scatter-plotting with custom colors",
                                          "/3d-scatter-plot-customizing/"],
                  ...
                  "Natural Language Processing with NLTK": [["Simple RSS feed scraping", "/scraping-parsing-rss-feed/"],
                                                            ...
                                                            ["Named Entity Recognition NLTK tutorial",
                                                             "/named-entity-recognition-nltk-python/"],

                                                            ["Building a Knowledge-base",
                                                             "/building-nlp-knowledge-base/"],
                                                            ["More Named Entity Recognition with NLTK",
                                                             "/more-named-entity-recognition/"],
                                                            ["Pulling related Sentiment about Named Entities",
                                                             "/finding-related-sentiment/"],
                  ...
                  "Support Vector Machines (SVM)": [["Intro to Machine Learning with Scikit Learn and Python",
                                                     "/machine-learning-python-sklearn-intro/"],
                                                    [
                                                        "Simple Support Vector Machine (SVM) example with character recognition",
                                                        "/support-vector-machine-svm-example-tutorial-scikit-learn-python/"],
                                                    ...
                                                    ["Structuring data with Pandas",
                                                     "/using-pandas-structure-process-data/"],
                                                    ["Getting more data and meshing data sets",
                                                     "/getting-data-sp-500-index-value-comparison/"],
                                                    ...
                                                    ["Linear SVC Machine learning SVM example with Python",
                                                     "/linear-svc-example-scikit-learn-svm-python/"],
                                                    ["Getting more features from our data",
                                                     "/collecting-features-machine-learning/"],
                                                    ["Linear SVC machine learning and testing our data",
                                                     "/linear-svc-machine-learning-testing-data/"],
                                                    ...
                                                    [
                                                        ...
                                                        "/improving-analysis-machine-learning/"],
                                                    ["Learning and Testing our Machine learning algorithm",
                                                     "/learning-and-testing-svm/"],
                                                    ["More testing, this time including N/A data",
                                                     "/machine-learning-testing-with-na/"],
                                                    ["Back-testing the strategy",
                                                     "/back-testing-machine-learning-investing-strategy/"],
                                                    ["Pulling current data from Yahoo",
                                                     "/current-yahoo-data-for-machine-learning/"],
                                                    ["Building our New Data-set",
                                                     "/building-yahoo-data-machine-learning/"],
                                                    ["Searching for investment suggestions",
                                                     "/investment-suggestions-machine-learning/"],
                                                    ["Raising investment requirement standards",
                                                     "/raising-investment-suggestion-requirements/"],
                                                    ["Testing raised standards", "/machine-learning-testing-new-algo/"],
                                                    ["Streamlining the changing of standards",
                                                     "/streamlining-changing-machine-learning/"], ],

                  "Clustering (unsupervised learning)": [["Unsupervised Machine Learning: Flat Clustering",
                                                          "/flat-clustering-machine-learning-python-scikit-learn/"],
                                                         ["Unsupervised Machine Learning: Hierarchical Clustering",
                                                          "/hierarchical-clustering-machine-learning-python-scikit-learn/"], ],
                  ...
                  "Image Recognition": [["Introduction and Dependencies", "/image-recognition-python/"],
                                        ...
                                        ["Testing, visualization, and moving forward",
                                         "/testing-visualization-and-conclusion/"], ],

                  "Forex Algo HFT": [
                      ["Introduction", "/machine-learning-pattern-recognition-algorithmic-forex-stock-trading/"],
                  ...
                  "Robotics with the Raspberry Pi": [
                      ["Robotics with the Raspberry Pi", "/robot-remote-control-car-with-the-raspberry-pi/"],
                  ...
                  "Build a Supercomputer and program with MPI": [
                      ["Build a Supercomputer with Raspberry Pis", "/build-supercomputer-raspberry-pi/"],
                      ...
                      ["Installing mpi4py for use with Python and MPI",
                       "/installing-testing-mpi4py-mpi-python-tutorial/"],
                      ...
                      ["Using  conditional, Python, statements alongside MPI commands example",
                       "/conditional-statements-alongside-mpi-mpi4py/"],
                  ...
                  "Tkinter": [["Programming GUIs and windows with Tkinter and Python Introduction ",
                              ...
                              ["Passing functions with Parameters in Tkinter using Lambda",
                               "/passing-functions-parameters-tkinter-using-lambda/"],
                              ...
                              ["How to embed a Matplotlib graph to your Tkinter GUI",
                               "/how-to-embed-matplotlib-graph-tkinter-gui/"],
                              ["How to make the Matplotlib graph live in your application",
                               "/embedding-live-matplotlib-graph-tkinter-gui/"],
                              ...
                              ["Customizing an embedded Matplotlib Graph in Tkinter",
                               "/customizing-tkinter-matplotlib-graph/"],
                              ...
                              ["Graphing an OHLC candlestick graph embedded in our Tkinter GUI",
                               "/graphing-ohlc-candlestick-in-tkinter/"],
                              ...
                              ["Converting Tkinter application to .exe and installer with cx_Freeze",
                               "/converting-tkinter-to-exe-with-cx-freeze/"], ],

                  "Python and Pandas with Sentiment Analysis Database": [
                      ["Python and Pandas with Sentiment Analysis Database",
                       "/python-and-pandas-for-sentiment-analysis-and-finance/"],
                  ...
                  "Creating a Monte Carlo simulator": [["Monte Carlo Introduction", "/monte-carlo-simulator-python/"],
                                                       ...
                                                       ["Plotting Results with Matpltolib",
                                                        "/plotting-monte-carlo-matplotlib/"],
                                                       ...
                                                       ["Finding best D'Alembert Multiple",
                                                        "/snooping-best-dalembert-multiple/"],
                                                       ["Two dimensional charting monte carlo",
                                                        "/two-dimension-graph-monte-carlo/"],
                                                       ["Monte Carlo Simulation and Python", "/monte-carlo-python/"],
                                                       ["Labouchere System for Gambling Tested",
                                                        "/testing-labouchere/"], ],

                  "IBpy": [["IBPy Tutorial for using Interactive Brokers API with Python",
                            "/ibpy-tutorial-using-interactive-brokers-api-python/"], ],

                  "Programming for Fundamental Investing": [
                      ["Programming for Fundamental Investing", "/python-fundamental-investing/"],
                      ...
                      ["Completing the Fundamental Investing Stock Screeners",
                       "/fundamental-investing-stock-screener-conclusion/"], ],
